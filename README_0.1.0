...
#### 🔗 [독립 즐기러가기](http://i5a501.p.ssafy.io/) <br>

📢 [문서 읽으러가기](#-content) ➡ 설명글을 참고하여주세요❗  <br> <br>



![image](/uploads/98ed0e9b14373c95b991e03a1e48a2ff/image.png)
...
1. [🌞 기본](#-기본)
    <br>
    - [☝ 로고 클릭](#-상단에-위치한-로고-클릭-시-메인-페이지로-이동)
    <br>
2. [💌 메인](#-메인)
    <br>
    - [💛 전체](#-전체-페이지)
    - [👩 Header](#-header에-마우스-오버-시-상세-메뉴-등장)
    - [🦶 Footer](#-footer-에는-로고-및-견과류의-정보-제공)
    <br>
3. [🔐 로그인](#-로그인)
    <br><br>
4. [📰 입양 / 임보](#-입양-/-임보)
