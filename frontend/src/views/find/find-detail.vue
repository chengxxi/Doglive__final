...
"
        ...
        <!-- 유사공고 -->
        <div v-if="state.listSimilarDog.length != 0">     <!-- 조건 걸기 -->
          <div class="dog-image-box">
            ...
            <el-scrollbar>
              <div class="flex-content">
                <p class="item" v-for="(card, idx) in state.listSimilarDog" :key="idx" style="width:360px; margin: 5px; display:inline-block">
                  <FindCard
                    :card="card"
