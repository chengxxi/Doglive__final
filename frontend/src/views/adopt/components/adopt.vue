<template>
  <div class="main-body main-padding">
    <el-card class="box-card " style="width:100%; border:none;" shadow="hover">
      ...
      <div>
        <el-button :plain="true" @click="readData9" round
          >테스트용 : 9번 보드 읽기</el-button
        >
        <el-button :plain="true" @click="readData" round
          >테스트용 : 13번 보드 읽기</el-button
        >
...
<script>
import AdoptFilter from "@/views/adopt/components/adopt-filter.vue";
import AdoptList from "@/views/adopt/components/adopt-list.vue";
