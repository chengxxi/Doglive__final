...
<div>
  <div class="box">
    ...
    <p>
      ...
      "독립"의 'MPTI'를 통해 새롭게 우리 가족이 될 강아지를 발견해 보세요. <br>
    </p>
  ...
  <div class="mbtiBtn">
      <!-- round option -->
      <a href="/mbti/test">
        <el-button class="goMbtiBtn" round>MBTI 테스트 하러 가기</el-button>
      </a>
      <a href="/mbti/info">
        <el-button class="showMbtiBtn" round>독립 MBTI 테스트 유형 보기</el-button>
      </a>
